...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./Applications/project/sct-mediko/public/storage' => 'string',
...
'broadcasting.connections.reverb.driver','broadcasting.connections.pusher.driver','broadcasting.connections.pusher.key','broadcasting.connections.pusher.secret','broadcasting.connections.pusher.app_id',
...
'datatables.columns.whitelist','datatables.json.header','datatables.json.options','datatables.callback','debugbar.enabled',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.links./Applications/project/sct-mediko/public/storage','logging.default','logging.deprecations.channel',
...
'passport.personal.tokens.destroy','generated::AuMEycf4jmdWGX9Y','index','create','store',
'show','edit','update','destroy','forgot-password.index',
'forgot-password.create','forgot-password.store','forgot-password.show','forgot-password.edit','forgot-password.update',
'forgot-password.destroy','login','register','login.check','register.store',
'login.logout','send.otp','verify.otp.view','change.password.view','verify.otp',
'change.password','profile.index','profile.create','profile.store','profile.show',
'profile.edit','profile.update','profile.destroy','tryout.index','tryout.create',
'tryout.store','tryout.show','tryout.edit','tryout.update','tryout.destroy',
'task-history.index','task-history.create','task-history.store','task-history.show','task-history.edit',
'task-history.update','task-history.destroy','tryout-archive.index','tryout-archive.create','tryout-archive.store',
'tryout-archive.show','tryout-archive.edit','tryout-archive.update','tryout-archive.destroy','list-package.index',
'list-package.create','list-package.store','list-package.show','list-package.edit','list-package.update',
'list-package.destroy','payment.index','payment.create','payment.store','payment.show',
'payment.edit','payment.update','payment.destroy','dashboard.index','dashboard.create',
'dashboard.store','dashboard.show','dashboard.edit','dashboard.update','dashboard.destroy',
'student.index','student.create','student.store','student.show','student.edit',
'student.update','student.destroy','access-role.index','access-role.create','access-role.store',
'access-role.show','access-role.edit','access-role.update','access-role.destroy','user-management.index',
'user-management.create','admin.user-management.private','user-management.show','user-management.edit','user-management.update',
'user-management.destroy','list-students.index','list-students.create','list-students.store','list-students.show',
'list-students.edit','list-students.update','list-students.destroy','broadcast.index','broadcast.create',
'broadcast.store','broadcast.show','broadcast.edit','broadcast.update','broadcast.destroy',
'question.index','question.create','question.store','question.show','question.edit',
'question.update','question.destroy','medical-field.index','medical-field.create','medical-field.store',
'medical-field.show','medical-field.edit','medical-field.update','medical-field.destroy','question-detail.index',
'question-detail.create','question-detail.store','question-detail.show','question-detail.edit','question-detail.update',
'question-detail.destroy','sub-topic.index','sub-topic.create','sub-topic.store','sub-topic.show',
'sub-topic.edit','sub-topic.update','sub-topic.destroy','topic.index','topic.create',
'topic.store','topic.show','topic.edit','topic.update','topic.destroy',
'setting.index','setting.create','setting.store','setting.show','setting.edit',
'setting.update','setting.destroy','package.index','package.create','package.store',
'package.show','package.edit','package.update','package.destroy','question-detail-type.index',
'question-detail-type.create','question-detail-type.store','question-detail-type.show','question-detail-type.edit','question-detail-type.update',
'question-detail-type.destroy','question-bank.index','question-bank.create','question-bank.store','question-bank.show',
'question-bank.edit','question-bank.update','question-bank.destroy','column-title.index','column-title.create',
'column-title.store','column-title.show','column-title.edit','column-title.update','column-title.destroy',
'list-invoice.index','list-invoice.create','list-invoice.store','list-invoice.show','list-invoice.edit',
'list-invoice.update','list-invoice.destroy','quiz.index','quiz.create','quiz.store',
'quiz.show','quiz.edit','quiz.update','quiz.destroy','quiz-question.index',
'quiz-question.create','quiz-question.store','quiz-question.show','quiz-question.edit','quiz-question.update',
'quiz-question.destroy','quiz-question-bank.index','quiz-question-bank.create','quiz-question-bank.store','quiz-question-bank.show',
'quiz-question-bank.edit','quiz-question-bank.update','quiz-question-bank.destroy','tryout.question.detail','admin.access-role.private',
'admin.access-role.public','admin.access-role.menus','admin.access-role.get.permission','broadcast.data','question-list.index',
'payment-histories.index','question.preview','question-detail.detail.edit','package.search.question','package.getSelectedQuestions',
'admin.searchQuestionBank','admin.access-role.data','admin.access-role.permission','admin.list-student.public','admin.broadcast.table',
'broadcast.read','question.table','admin.question.upload_image','admin.question.upload_file','question.get-questions',
'question.attach-question-detail','question.detach-question-detail','admin.medical-fields.table','admin.medical-fields.dropdown','admin.topic.table',
'admin.topic.data','admin.sub-topic.table','update.password','tryout.history.answer','package.question.destroy',
'generated::8XACEMRSy4e7zAVY','storage.local',);
        registerArgumentsSet('views', 
'admin.access_role','admin.broadcast','admin.column_title','admin.dashboard','admin.list_invoices',
'admin.list_questions','admin.list_student','admin.make_question','admin.medical_field','admin.package',
'admin.preview_question','admin.question_bank','admin.question_bank_mapping','admin.question_detail','admin.question_detail_edit',
'admin.question_detail_show','admin.question_detail_type','admin.setting','admin.sub_topic','admin.user_management',
'auth.change-password','auth.forgot-password','auth.login','auth.register','auth.verify-otp',
'emails.otp','layouts.app','partials.footer','partials.navbar','partials.script',
'partials.sidebar','passport::authorize','public.dashboard','public.list_package','public.payment',
'public.payment_history','public.profile','public.tryout','public.tryout_history','public.tryout_result',
'quiz.content.index','quiz.content.layouts.create_quiz','quiz.content.layouts.create_quiz_question_bank','quiz.content.layouts.edit_quiz','quiz.content.layouts.quiz_question_list',
'quiz.partials.navbar','quiz.partials.sidebar','vendor.passport.authorize','welcome','laravel-exceptions-renderer::components.card',
...
'pagination::simple-bootstrap-5','pagination::simple-default','pagination::simple-tailwind','pagination::tailwind','passport::authorize',);
...
'VITE_APP_NAME','PUSHER_APP_ID','BROADCAST_DRIVER','PUSHER_APP_KEY','PUSHER_APP_SECRET',
'PUSHER_APP_CLUSTER','MAIL_MAILER','MAIL_HOST','MAIL_PORT','MAIL_USERNAME',
'MAIL_PASSWORD','MAIL_ENCRYPTION','MAIL_FROM_ADDRESS','MAIL_FROM_NAME','REDIS_HOST',
'REDIS_PASSWORD','REDIS_PORT','QUEUE_CONNECTION','REVERB_APP_ID','REVERB_APP_KEY',
