...
<div class="form-card">
    <div class="form-body">
        <div class="form-title">
            ...
            <p class="subtitle">Perbarui informasi pertanyaan medmastery</p>
        </div>
        ...
        <form action="{{ route('medmastery-question.update', $question->id) }}" method="POST" id="questionForm" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="input-group">
                ...
                <select class="form-input @error('medmastery_category_id') is-invalid @enderror" 
                    ...
                    @foreach($categories as $category)
                        <option value="{{ $category->id }}" {{ (old('medmastery_category_id', $question->medmastery_category_id) == $category->id) ? 'selected' : '' }}>
            ...
            <div class="input-group">
                ...
                <textarea class="form-input form-textarea @error('explanation') is-invalid @enderror" 
                          id="explanation" 
                          name="explanation" 
                ...
                <div class="pdf-upload-container">
                        ...
                        @if($question->explanation_pdf_path)
                            <div class="current-pdf">
                                ...
                                <div style="flex: 1;">
                                    ...
                                    <small style="color: #718096;">{{ basename($question->explanation_pdf_path) }}</small>
                                </div>
                                <div style="display: flex; gap: 0.5rem;">
                                    <a href="{{ $question->explanation_pdf_url }}" target="_blank" class="btn btn-secondary" style="padding: 0.25rem 0.5rem; font-size: 0.8rem;">
                                        <i class="fas fa-external-link-alt"></i> Lihat
                                    </a>
                                </div>
                            </div>
                            <div class="upload-info">
                                <strong>Pilih file baru untuk mengganti PDF yang ada</strong>
                            </div>
                        @else
                    ...
                    <div class="upload-button">
                        <button type="button" class="btn-upload" onclick="document.getElementById('explanation_pdf').click()">
                            <i class="fas fa-upload me-2"></i>{{ $question->explanation_pdf_path ? 'Ganti File PDF' : 'Pilih File PDF' }}
                        </button>
                    </div>
                </div>
            ...
            <div class="input-group">
                ...
                <div class="switch-container">
                    ...
                    <span id="statusText">{{ $question->is_active ? 'Aktif' : 'Tidak Aktif' }}</span>
                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function handleFileSelect(file) {
        ...
        pdfPreview.innerHTML = `
            ...
            <div class="upload-info">
                <strong>File baru akan mengganti PDF yang ada</strong>
            </div>
        `;
    }
    ...
    addCharacterCounter(explanation, 5000);
