...
<div class="form-card">
    <div class="form-body">
        <div class="form-title">
            ...
            <p class="subtitle">Buat kategori baru untuk mengorganisir konten medmastery</p>
        </div>
        ...
        <form action="{{ route('medmastery-category.store') }}" method="POST" id="categoryForm" enctype="multipart/form-data">
            @csrf
            ...
            <div class="input-group">
                ...
                <select class="form-input @error('medmastery_segmentation_id') is-invalid @enderror" 
                    ...
                    @foreach($segmentations as $segmentation)
                        <option value="{{ $segmentation->id }}" {{ old('medmastery_segmentation_id') == $segmentation->id ? 'selected' : '' }}>
                            {{ $segmentation->name }}
                        </option>
                    @endforeach
                </select>
            ...
            <div class="input-group">
                ...
                <select class="form-input @error('access') is-invalid @enderror" 
                    ...
                    <option value="public" {{ old('access') == 'public' ? 'selected' : '' }}>
                        Public - Dapat dilihat oleh semua pengguna
                    </option>
                    <option value="private" {{ old('access') == 'private' ? 'selected' : '' }}>
            ...
            <div class="input-group d-flex flex-column">
                <label for="icon">
                    Gambar Ikon Kategori <span class="required">*</span>
                </label>
                <div class="image-upload-container">
                    ...
                    <input type="file"  class="d-none"
                           class="form-input-file @error('icon') is-invalid @enderror" 
                           id="icon" 
                           name="icon" 
                           accept=".png"
                           required>
                    <div class="upload-button">
                        <button type="button" class="btn-upload" onclick="document.getElementById('icon').click()">
                            <i class="fas fa-upload me-2"></i>Pilih Gambar PNG
                        </button>
                    </div>
                </div>
                <div class="help-text">Upload gambar PNG dengan ukuran maksimal 2MB untuk ikon kategori</div>
                @error('icon')
                    <div class="invalid-feedback">
                        <i class="fas fa-exclamation-circle"></i>{{ $message }}
                    </div>
